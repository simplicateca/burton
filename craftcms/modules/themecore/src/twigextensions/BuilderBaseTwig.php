<?php
/**
 * ThemeCore - Normalize Block Twig Extension
 *
...
/**------------------------------------------------------------------------------------/
 ...
 2) Merge any provided `settings` with the ones generated by the primary attribute
    ...
    MetaSettings fields, they provide both a `value` and an array of related `settings`.
...
/**------------------------------------------------------------------------------------/
    {
        ...
        variant : <MetaSettingsFieldObject>,
        layout  : <MetaSettingsFieldObject>,
        theme   : <MetaSettingsFieldObject>,
        settings: {
